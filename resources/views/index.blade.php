...
@section('content')
            ...
            <div class="row align-items-center min-vh-100 py-5">
                ...
                <div class="col-lg-5 d-none d-lg-flex justify-content-center">
                    <div class="hero-visual">
                        <img src="{{ asset('images/logoBalai.png') }}" alt="Siger Baltik Lampung" class="siger-illustration"
    ...
    <section class="section-menu py-6">
        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-6 col-lg-3">
                    <a href="{{ config('site.youtube_url') }}" target="_blank" rel="noopener"
                        class="menu-card menu-youtube">
                ...
                <div class="col-6 col-lg-3">
                    <a href="{{ config('site.rmd') }}" target="_blank" rel="noopener" class="menu-card menu-rmd">
                        <div class="menu-icon">
                            <img src="{{ asset('images/rmd.webp') }}" alt="RMD"
                ...
                <div class="col-6 col-lg-3">
                    <a href="{{ config('site.dsmart') }}" target="_blank" rel="noopener" class="menu-card menu-dsmart">
                        <div class="menu-icon">
                            <img src="{{ asset('images/dsmart.png') }}" alt="D Smart"
                                style="height:48px;object-fit:contain;">
                        </div>
                        <h5>D Smart</h5>
        ...
        <div class="container py-3">
            <div class="row align-items-center g-5">
                <div class="col-lg-5">
                    ...
                    <p class="text-muted">Platform kami dirancang khusus untuk kebutuhan pelajar Lampung dengan konten yang
                        relevan dan mudah diakses.</p>
    ...
    <section class="section-budaya py-6 bg-light-custom">
        ...
        <div class="container py-5">
            ...
            <!-- UPDATE 1: Tambahkan row-cols-2 (mobile) dan row-cols-md-5 (desktop) -->
            <div class="row g-4 row-cols-2 row-cols-md-5">
                ...
                <div class="col">
                    <div class="budaya-card text-center">
                        <div class="budaya-icon">🗣️</div>
                        <h6>Bahasa Lampung</h6>
                        <p>Bahasa daerah dan percakapan masyarakat Lampung</p>
                    </div>
                </div>
