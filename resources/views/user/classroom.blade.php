...
@section('title', !empty($session_sekolah_id) ? 'Classroom Saya' : 'Monitoring Classroom')
@section('page_title', !empty($session_sekolah_id) ? 'Classroom Saya' : 'Kelola & Monitoring
    Classroom')
        ...
        <div class="row g-3">
            <div class="col-lg-7 mx-auto">
                ...
                <div class="admin-card mt-3">
                    <div class="admin-card-header">
                        <span class="admin-card-title"><i class="bi bi-collection-play me-2"></i>Kelas per Mata
                            Pelajaran</span>
                    </div>
                    <div class="p-3">
                        ...
                        <button class="btn btn-admin-edit w-100"
                            onclick="location.href='/admin/classroom/{{ $session_sekolah_id }}'">
        ...
        <div class="admin-card">
            ...
            <div class="p-3 border-bottom">
                <div class="admin-filter-bar">
                    ...
                    <select id="filterJenjangAdmin" class="form-select" style="max-width:160px"
                        onchange="loadSekolahAdmin()">
                        <option value="">Semua Jenjang</option>
                        <option value="sma">🎓 SMA</option>
                        <option value="smk">🔧 SMK</option>
                        <option value="slb">🌟 SLB</option>
                    </select>
                    <button class="btn btn-outline-secondary btn-sm" onclick="resetFilterSekolah()"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="border-radius:16px; border:none">
                    <div class="modal-header border-0 pb-0">
                        <h6 class="modal-title fw-700" id="modalSekolahTitle" style="font-family:'Sora',sans-serif">Tambah
                            Sekolah</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="fNamaSekolah" class="form-control"
                        ...
                        <p class="text-muted small mb-0">
                            <i class="bi bi-info-circle me-1"></i>Link Google Classroom per mata pelajaran dikelola lewat
                            halaman
                            <strong>Kelola Kelas</strong> (ikon <i class="bi bi-collection-play"></i>) setelah sekolah ini
                            disimpan.
                        </p>
                    </div>
...
@section('scripts')
    ...
    <script>
        const CLASSROOM_ROLE = "{{ $session_role ?? 'admin_sistem' }}";
